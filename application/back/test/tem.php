...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="../../tp/images/favicon.png">
    <title>Ela - Bootstrap Admin Dashboard Template</title>
    <!-- Bootstrap Core CSS -->
    <link href="../../tp/css/lib/bootstrap/bootstrap.min.css" rel="stylesheet">
    <!-- Custom CSS -->

    <link href="../../tp/css/lib/calendar2/semantic.ui.min.css" rel="stylesheet">
    <link href="../../tp/css/lib/calendar2/pignose.calendar.min.css" rel="stylesheet">
    <link href="../../tp/css/lib/owl.carousel.min.css" rel="stylesheet" />
    <link href="../../tp/css/lib/owl.theme.default.min.css" rel="stylesheet" />
    <link href="../../tp/css/helper.css" rel="stylesheet">
...
<body class="fix-header fix-sidebar">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        <!-- Logo icon -->
                        <b><img src="../../tp/images/logo.png" alt="homepage" class="dark-logo" /></b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span><img src="../../tp/images/logo-text.png" alt="homepage" class="dark-logo" /></span>
                    </a>
                </div>
                <!-- End Logo -->
                <div class="navbar-collapse">
                                ...
                                <ul class="mega-dropdown-menu row">
                                    ...
                                    <li class="col-lg-3 col-xlg-3 m-b-30">
                                        ...
                                        <ul class="list-style-none">
                                            <li><a href="../../tp/javascript:void(0)"><i class="fa fa-check text-success"></i> This Is Another Link</a></li>
                                            <li><a href="../../tp/javascript:void(0)"><i class="fa fa-check text-success"></i> This Is Another Link</a></li>
                                            <li><a href="../../tp/javascript:void(0)"><i class="fa fa-check text-success"></i> This Is Another Link</a></li>
                                            <li><a href="../../tp/javascript:void(0)"><i class="fa fa-check text-success"></i> This Is Another Link</a></li>
                                            <li><a href="../../tp/javascript:void(0)"><i class="fa fa-check text-success"></i> This Is Another Link</a></li>
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <!-- Profile -->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="../../tp/images/users/5.jpg" alt="user" class="profile-pic" /></a>
    ...
    <!-- End Wrapper -->
    <!-- All Jquery -->
    <script src="../../tp/js/lib/jquery/jquery.min.js"></script>
    <!-- Bootstrap tether Core JavaScript -->
    <script src="../../tp/js/lib/bootstrap/js/popper.min.js"></script>
    <script src="../../tp/js/lib/bootstrap/js/bootstrap.min.js"></script>
    <!-- slimscrollbar scrollbar JavaScript -->
    <script src="../../tp/js/jquery.slimscroll.js"></script>
    <!--Menu sidebar -->
    <script src="../../tp/js/sidebarmenu.js"></script>
    <!--stickey kit -->
    <script src="../../tp/js/lib/sticky-kit-master/dist/sticky-kit.min.js"></script>
    <!--Custom JavaScript -->


    <!-- Amchart -->
     <script src="../../tp/js/lib/morris-chart/raphael-min.js"></script>
    <script src="../../tp/js/lib/morris-chart/morris.js"></script>
    <script src="../../tp/js/lib/morris-chart/dashboard1-init.js"></script>


	<script src="../../tp/js/lib/calendar-2/moment.latest.min.js"></script>
    <!-- scripit init-->
    <script src="../../tp/js/lib/calendar-2/semantic.ui.min.js"></script>
    <!-- scripit init-->
    <script src="../../tp/js/lib/calendar-2/prism.min.js"></script>
    <!-- scripit init-->
    <script src="../../tp/js/lib/calendar-2/pignose.calendar.min.js"></script>
    <!-- scripit init-->
    <script src="../../tp/js/lib/calendar-2/pignose.init.js"></script>

    <script src="../../tp/js/lib/owl-carousel/owl.carousel.min.js"></script>
    <script src="../../tp/js/lib/owl-carousel/owl.carousel-init.js"></script>
    <script src="../../tp/js/scripts.js"></script>
    <!-- scripit init-->

    <script src="../../tp/js/custom.min.js"></script>
